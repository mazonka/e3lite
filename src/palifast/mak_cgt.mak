...
cgt.exe: $(BIN) $(CRDIR) $(objl) $(obju2) $(obju2sis) $(obju1) $(objk1) $(objk2) \
	$(objcr) $(BIN)/cuddObj.$(OEXT) $(objcu) $(LDF1)
	$(CCN) $(OPTS) $(objl) $(obju2) $(obju2sis) $(obju1) \
...
$(obju2sis): $(BIN)/%.$(OEXT):cpp_share/util/%.cpp cpp_share/util/*.h cpp_share/util/*.inc
	$(CCN) -c -DPLAT=$(PLAT) $(OPTS) $< $(OOUT)$@
