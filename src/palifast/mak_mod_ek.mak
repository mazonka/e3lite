...
srcu2sis=cpp_share/util/def_pali_sis$(PALI).cpp cpp_share/util/def_palisade_ckks_util$(PALI).cpp
#srcu2sis=cpp_share/util/def_pali_sis$(PALI).cpp
obju2sis := $(srcu2sis:cpp_share/util/%.cpp=$(BIN)/%.$(OEXT))
